...
List<EServices> eServicesFromJson(String str) =>
    List<EServices>.from(json.decode(str).map((x) => EServices.fromJson(x)));

String eServicesToJson(List<EServices> data) =>
...
class EServices {
  ...
  factory EServices.fromJson(Map<String, dynamic> json) => EServices(
        ...
        targets: List<Category>.from(
            json["targets"].map((x) => Category.fromJson(x))),
