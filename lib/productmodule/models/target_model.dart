...
class Target {
  ...
  factory Target.fromJson(Map<String, dynamic> json) => Target(
    ...
    eservices: List<Eservice>.from(json["eservices"].map((x) => Eservice.fromJson(x))),
  );
...
class Eservice {
  ...
  factory Eservice.fromJson(Map<String, dynamic> json) => Eservice(
    ...
    manual: json["manual"] == null ? null : (Icon.fromJson(json["manual"]) as Icon),
...
final periodValues = EnumValues({
  ...
  "لايوجد": Period.FLUFFY,
  "من يوم الى ثلاثة أيام عمل": Period.PERIOD,
  "فوري": Period.PURPLE,
  "من خمسة الى سبعة ايام": Period.TENTACLED
});
